...
void wifi_init()                                //This function contains AT commands that passes to connect_wifi()
{
      ...
      if(!No_IP)
      {
        ...
        connect_wifi("AT+CWJAP=\"Tenda_7F50C8\",\"Vansh024@\"",7000);         //provide your WiFi username and password here
...
{
      webpage = "<h1>HELLO Mr. AMAN JAISWAL</h1><body bgcolor=f0f0f0>";
      sendwebdata(webpage);
      webpage=name;
      sendwebdata(webpage);
      delay(1000);
      webpage = "<a href=\"http://superspoiler210.blogspot.com/\"";
      webpage+="\">Click Here to get into MY WEBSITE superspoiler.com</a>";
      webpage+=data;
      sendwebdata(webpage);
